...
import { Filter, FilterFormValues, FilterSchema } from "@/types/filter";
import { useCreateFilter } from "@/hooks/filter/useCreateFilter";
import { useUpdateFilter } from "@/hooks/filter/useUpdateFilter";
...
export default function FilterForm({
  ...
  const defaultFormValues: FilterFormValues = initialData
    ? {
              ...
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="FLATCONE">Flat cone</SelectItem>
                    <SelectItem value="DISK">Disk</SelectItem>
                    <SelectItem value="WAVY">Wavy</SelectItem>
                    <SelectItem value="BASKET">Basket</SelectItem>
                    <SelectItem value="SACK">Sack / Cloth bag</SelectItem>
              ...
              <FormItem>
                ...
                <Select value={field.value} onValueChange={field.onChange}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="UNBLEACHEDPAPER">
                      Unbleached paper
                    </SelectItem>
