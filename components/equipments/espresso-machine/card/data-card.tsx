...
export default function DataCard({ data }: { data: EspressoMachine[] }) {
  const getTypeVariant = (type: string) => {
    if (type.toLowerCase() === "lever") return "default";
    if (type.toLowerCase() === "automatic") return "secondary";
    return "outline";
  };
    ...
    return (
      <div className="col-span-full flex items-center justify-center rounded-lg border border-dashed p-10 text-center">
        <div className="space-y-2">
          <p className="text-sm font-medium">No espresso machine found.</p>
